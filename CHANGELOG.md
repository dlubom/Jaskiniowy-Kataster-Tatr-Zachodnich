...
- Przejscie na semver, uproszczenie INFO.txt, aktualizacja README.md

## [v0.28] - 2024-05-08

- Aktualizacja README i dokumentacji, dodano nowe obrazy

## [v0.27] - 2020-06-20

- Wykomentowano duplikaty pomiarow w wielu jaskiniach (Wielka Sniezna, Wielka Litworowa, Wysoka Za 7 Progami, Mala w Mulowej, Przy Przechodzie, Bandzioch Kominiarski, Zaspalkowa Szczelina, Zwolinskiego), poprawki struktury
...
- Dodano jaskinie Smocza Jama, rozpoczeto prace nad jaskinia Dziura
...
- Aktualizacja dla jaskini Hardej. Nowe pomiary.
...
- Dodatkowo kosmetyczne poprawki
...
- Dodano jaskinie Spiacych Rycerzy (fragment), Jaskinia Lodowa Mietusia, Szczelina Mietusia, Zbójecka Dziura, Szczelina nad Tomanowa II (brak wsp GPS), Szczelina nad Tomanowa I (brak wsp GPS), Dziura w Stole (brak wsp GPS), Jaskinia Zawaliskowa Tomanowa (brak wsp GPS), Jaskinia Poszukiwaczy Skarbow (fragment), Jaskinia Pod Zamkiem (fragment), Jaskinia w Zbójnickiej Turni (brak wsp GPS), Zbójnicka Piwnica (brak wsp GPS), Jaskinia Ziobrowa i Jaskinia pod Niznia Zbojnicka Turnia, Jaskinia Ciepla (brak wsp GPS), Gawra, Rura przy Oknie (brak wsp GPS), Lustrzany Korytarz (brak wsp GPS), Jaskinia nad Percia (brak wsp GPS), Jaskinia nad Beczka (brak wsp GPS)
