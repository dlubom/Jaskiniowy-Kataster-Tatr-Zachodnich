...
- **resvg dokładnie 0.48.1** — pobierz odpowiednie archiwum z
  ...
  [manifestu dla macOS arm64 i Linux x86_64](evidence/p01/renderer/manifest.json),
  rozpakuj i wskaż program przez `--resvg` lub zmienną `RESVG`.
  [Instrukcja odtworzenia próby renderera](evidence/p01/renderer/README.md#odtworzenie-lokalne-i-w-linux-ci)
...
[`gui-cardinal/source.top`](evidence/p01/cases/gui-cardinal/source.top)
...
Szczegóły opisuje [polityka projekcji](evidence/p05/projection.md).
...
Zobacz [ograniczenia kompilacji](evidence/p04/COMPILER_LIMITS.md).
