...
Podstawa: specyfikacja **„PocketTopo File Formats”, 17.3.2010 bh (Beat Heeb)**.
Publiczna kopia:
...
To kontrakt wejścia konwertera; `.cal` v1 jest poza jego zakresem.
Użycie i reguły decyzji opisuje [CLI](CLI.md), a pochodzenie badań
...
- `time`: ticks po 100 ns od 0001-01-01; nie przechodzić przez float.
  Zegar urządzenia może być zresetowany. Zachować datę źródłową; data pomiaru
  wymaga niezależnego potwierdzenia. Konwerter nie wylicza z niej deklinacji
  ani nie zastępuje jej datą z nazwy pliku.
...
- `Trip.declination=-32768` (`00 80`): tryb **Auto** w PocketTopo 1.372,
  ...
  oznacza potwierdzonej jawnej zerowej korekty.
  [Archiwalny dowód natywny](https://github.com/dlubom/Jaskiniowy-Kataster-Tatr-Zachodnich/blob/3e3daa4156c6e6e79dce5203d8bb8e36122d571f/doc/pockettopo/evidence/p01/NATIVE_API.md).
...
Sześć [wzorców natywnych](../../tests/fixtures/pockettopo/p01/cases), lokalne źródła i próbki
...
zapis przywraca cztery zera.
[Archiwalna metoda, SHA aplikacji i wyniki](https://github.com/dlubom/Jaskiniowy-Kataster-Tatr-Zachodnich/blob/3e3daa4156c6e6e79dce5203d8bb8e36122d571f/doc/pockettopo/evidence/p01/NATIVE_API.md).

**Kontrakt ścisłego parsera:** dopuszczać EOF dokładnie po znaczniku końca
