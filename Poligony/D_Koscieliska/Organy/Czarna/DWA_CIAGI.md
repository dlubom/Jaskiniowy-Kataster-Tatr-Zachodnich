...
Poniższa tabela opisuje przyjęty wariant D39→40=12,20 m.
...
nie dowodzi odczytu cyfry ze skanu ani poprawności nawiązań. Użytkownik
przyjął **12,20 m** po porównaniu odczytu i lokalnej kontroli sin/cos:
`12,20*cos(17°)=11,6669 m`, `12,20*sin(−17°)=−3,5669 m`.
Z `Lh=11,66 m` wynika `D=12,1928 m`. W SRV pozostaje zwykła uwaga
o niepewności z alternatywą 12,80 m; wybór wartości aktywnej jest zatwierdzony.
Dla `dh_scan` zachowano −3,55 m z alternatywą −3,59 m.
...
Wartość 12,45 m pochodzi z innego porównania: obu surowych ciągów
...
## Źródło odczytu i zachowane alternatywy
...
z 2026-09-19; poprzednia wartość 68° była robocza. Dla D39→40 użytkownik
przyjął **12,20 m**, zachowując 12,80 m jako niepewną alternatywę w komentarzu.
Nie zmieniono pozostałych D/A/V względem wcześniejszej transkrypcji. Uwzględniono potwierdzone przez użytkownika
...
| Odcinek | Pole | Przyjęto | Alternatywa |
| --- | --- | ---: | ---: |
| 39–40 | D | 12,20 m | 12,80 m |
| 39–40 | dh_scan | −3,55 m | −3,59 m |
...
optymalizację geometrii. D39→40=12,20 m jest przyjęte przez użytkownika,
a niepewność źródłowa pozostaje w komentarzu. Różnica surowych końców
obu ciągów wynosi 12,45 m; nadal nie jest błędem zamknięcia. Błędy dojścia starej sieci do
...
- 77 rekordów nowego dziennika zgodnych z `c878b7b`; jedyny wyjątek D/A/V
  to zatwierdzone A49→50=88°. D39→40=12,20 m jest zgodne z tą transkrypcją.
  Skrypt pilnuje przyjętych wartości i odrzuca inne zmiany. 205 istniejących SRV spoza `_RAW` pozostaje
...
- Jedenaście kontrolnych kompilacji Survex 1.4.22 bez ostrzeżeń: układ bazowy,
  ...
  sieć dla alternatywnego D39→40=12,80 m. Sprawdzono 12 080 starych nazwanych
