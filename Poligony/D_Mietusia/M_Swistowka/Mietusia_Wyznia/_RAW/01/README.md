# Mietusia Wyznia - paczka zrodlowa 01
...
- **Daty pomiarów:** 2024-05-30
- **Data pozyskania:** 2026-03-08
- **Dodał do _RAW:** Paweł Gogolak
...
- `otwor.svx` — ciąg główny
- `suche_dno.svx` — ciąg główny
- `mylna_rura.svx` — ciąg główny
- `wyznia_matka.svx` — ciąg główny
- `problem_speleoklubu.svx` — odnoga
- `traba.svx` — odnoga
- `trzy_syfony.svx` — odnoga
- `detektor_lawinowy.svx` — odnoga
- `pawlacz.svx` — odnoga
- `komin.svx` — odnoga
- `obejscie.svx` — odnoga
- `odejscie_l2.svx` — odnoga
- `mr_studnia.svx` — odnoga
- `urlop_tacierzynski.svx` — odnoga
- `perystaltyka.svx` — odnoga
- `mylna_rura_studnia.svx` — odnoga
